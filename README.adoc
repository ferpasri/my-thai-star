...
Forked project to prepare a mutation in the Graphical User Interface (GUI).

TESTAR tool will infer two State Models of the original GUI and this mutated GUI to automatically detect and report the GUI difference.

https://github.com/TESTARtool/TESTAR_dev/tree/decoder_master

Current mutated web application is deployed on port 9082.
...
23921e672489        mythaistar_java            "catalina.sh run"        3 minutes ago       Up 3 minutes        8080/tcp                                     mts_java_mutated
1acf2d6b6653        mythaistar_reverse-proxy   "nginx -g 'daemon of…"   3 minutes ago       Up 3 minutes        0.0.0.0:443->443/tcp, 0.0.0.0:8080->80/tcp   mts_reverse_proxy_mutated
fdb63e26d299        mythaistar_angular         "nginx -g 'daemon of…"   3 minutes ago       Up 3 minutes        80/tcp, 443/tcp                              mts_angular_mutated
```
